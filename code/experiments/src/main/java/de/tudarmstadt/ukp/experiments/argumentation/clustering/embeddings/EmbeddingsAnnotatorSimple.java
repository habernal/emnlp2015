 ...
 */
public class EmbeddingsAnnotatorSimple
        extends JCasAnnotator_ImplBase
{
            ...
            throws AnalysisEngineProcessException
    {
        ...
        for (Annotation annotation : selectAnnotationsForEmbeddings(aJCas)) {
            ...
            for (Token t : JCasUtil.selectCovered(Token.class, annotation)) {
                ...
                Embedding embedding = getEmbeddings(t.getCoveredText());
            ...
            throws Exception
    {
        ...
        String word2VecFile = args[2];

        File[] dirs = inputPath.listFiles(new FileFilter()
        {
        ...
        for (File dir : dirs) {
            ...
            File outDir = new File(outputPath, dir.getName());

            SimplePipeline.runPipeline(CollectionReaderFactory
                    .createReaderDescription(XmiReader.class, XmiReader.PARAM_SOURCE_LOCATION,
                            dir, XmiReader.PARAM_PATTERNS,
            ...
            SimplePipeline.runPipeline(CollectionReaderFactory.createReaderDescription(
                    XmiReader.class, XmiReader.PARAM_SOURCE_LOCATION, dir,
                    XmiReader.PARAM_PATTERNS, XmiReader.INCLUDE_PREFIX + "*.xmi"
                    ),
                    AnalysisEngineFactory.createEngineDescription(
                            EmbeddingsAnnotatorSimple.class,
                            EmbeddingsAnnotatorSimple.PARAM_CACHE_FILE, cacheFile,
                            EmbeddingsAnnotatorSimple.PARAM_WORD_2_VEC_FILE, word2VecFile,
                            EmbeddingsAnnotatorSimple.PARAM_TO_LOWERCASE, false
                    ),
                    AnalysisEngineFactory.createEngineDescription(
                            XmiWriter.class,
